export const texts = {
  en: {
    ...
    categoryPlaceholder: 'e.g. javascript, machine-learning',
    view: 'View',
    tableView: 'Table',
    cardView: 'Card',
  ...
  zh: {
    ...
    pageSize: '每页大小',
    category: '分类/关键词（可选）',
    categoryPlaceholder: '例如：javascript、machine-learning',
    view: '视图',
    tableView: '表格',
    cardView: '卡片',
    resetFields: '重置字段',
  ...
  fr: {
    ...
    categoryPlaceholder: 'ex. javascript, machine-learning',
    view: 'Vue',
    tableView: 'Tableau',
    cardView: 'Carte',
